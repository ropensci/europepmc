...
There is a considerable overlap between common names. The integration of ORCID, a persistent author identifier, allows unambigous search for personal publications in Europe PMC. For example, to search for publications written by Bernd Weisshaar (ORCID: <https://orcid.org/0000-0002-7635-3473>) sorted by the number of times cited in descending order:
