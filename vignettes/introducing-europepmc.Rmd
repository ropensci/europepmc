...
[Europe PMC](http://europepmc.org/) is a repository of life science literature. Europe PMC ingests all PubMed content and extends its index with other literature and patent sources. 
...
```{r}
europepmc::annotations_by_id(c("MED:28585529", "PMC:PMC1664601"))
```
